...
//   { label: 'Technology', key: 'technology', content: `Content for Technology goes here.` }
// ];

// const ProjectDomain = () => {
//   const [activeTab, setActiveTab] = useState('problem'); // Default is "Research Problem"
...
//           <h1 className="text-3xl sm:text-4xl font-bold mt-2">Project Domain</h1>
//         </div>
...
//             <button
//               key={section.key}
//               className={`px-4 py-2 rounded-md text-sm sm:text-base font-medium transition duration-200 ${
